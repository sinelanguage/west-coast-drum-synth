  ...
  static const std::array<FactoryPreset, kFactoryPresetCount> presets {
    FactoryPreset {
      ...
      {{
        ...
        lane (0.35, 0.42, 0.65, 0.45, 0.42, 0.20, 0.68, 0.58, 0.48, 0.40, 0.50, 0.52, 0.44, 0.42, 0.36, 0.52, 0.38, 0.50,  0.72, 0.12, 0.38, 0.76, 0.08, 0.42),
        lane (0.42, 0.38, 0.68, 0.48, 0.45, 0.22, 0.64, 0.62, 0.46, 0.38, 0.52, 0.55, 0.42, 0.44, 0.34, 0.54, 0.40, 0.52,  0.74, 0.11, 0.40, 0.78, 0.07, 0.44),
        lane (0.58, 0.36, 0.70, 0.50, 0.46, 0.24, 0.60, 0.68, 0.52, 0.34, 0.54, 0.58, 0.40, 0.48, 0.36, 0.56, 0.42, 0.54,  0.70, 0.14, 0.36, 0.74, 0.09, 0.40),
        lane (0.62, 0.34, 0.72, 0.52, 0.48, 0.26, 0.58, 0.72, 0.54, 0.32, 0.56, 0.60, 0.38, 0.50, 0.34, 0.58, 0.44, 0.56,  0.72, 0.13, 0.38, 0.76, 0.08, 0.42),
        lane (0.50, 0.38, 0.55, 0.42, 0.58, 0.28, 0.72, 0.55, 0.48, 0.40, 0.58, 0.68, 0.52, 0.72, 0.50, 0.62, 0.50, 0.62,  0.68, 0.16, 0.42, 0.72, 0.10, 0.48),
        lane (0.45, 0.42, 0.62, 0.38, 0.62, 0.32, 0.78, 0.52, 0.38, 0.45, 0.62, 0.72, 0.58, 0.65, 0.55, 0.68, 0.55, 0.68,  0.66, 0.18, 0.45, 0.70, 0.12, 0.52),
      }},
      {{
